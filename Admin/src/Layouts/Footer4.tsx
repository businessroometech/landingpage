...
const Footer4: React.FC = () => {
  const socialLinks = [
    { href: "#", src: "/assets/img/icons/facebook5.svg", alt: "Facebook" },
    { href: "#", src: "/assets/img/icons/instagram5.png", alt: "Instagram" },
    { href: "#", src: "/assets/img/icons/linkedin5.svg", alt: "LinkedIn" },
    { href: "#", src: "/assets/img/icons/youtube1.svg", alt: "YouTube" },
  ];
  ...
  return (
    <footer className="footer5-section-area">
      <Container>
        <Row>
          <Col lg={3} md={6}>
            <div className="footer-logo-area">
              <img src="/assets/img/logo/logo7.png" alt="Logo" />
              <p>
