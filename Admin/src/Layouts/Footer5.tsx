...
const Footer5: React.FC = () => {
  const socialLinks = [
    { href: "#", src: "/assets/img/icons/facebook3.svg", alt: "Facebook" },
    { href: "#", src: "/assets/img/icons/instagram3.svg", alt: "Instagram" },
    { href: "#", src: "/assets/img/icons/linkedin2.svg", alt: "LinkedIn" },
    { href: "#", src: "/assets/img/icons/twitter2.svg", alt: "Twitter" },
  ];
  ...
  return (
    <footer className="footer3-section-area">
      <Container>
        <Row>
          <Col lg={3} md={6}>
          ...
          <Col lg={4} md={6}>
            <div className="footer-logo-area3">
              ...
              <form action="#">
                ...
                <button className="header-btn4 btn2">
