...
const images = [
  ...
  { src: "/assets/img/icons/logo-icons3.svg", alt: "Logo Icon", className: "" },
  { src: "/assets/img/elements/line-img1.png", alt: "Line", className: "" },
  { src: "/assets/img/bg/bg2.png", alt: "Background 2", className: "bg-2" },
  {
