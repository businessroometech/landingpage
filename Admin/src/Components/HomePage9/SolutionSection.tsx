...
const solutionItems: SolutionItem[] = [
  {
    imageSrc: "/assets/img/all-images/solution-img1.png",
    step: "Step 01",
  ...
  {
    imageSrc: "/assets/img/all-images/solution-img2.png",
    step: "Step 02",
  ...
  {
    imageSrc: "/assets/img/all-images/solution-img3.png",
    step: "Step 03",
                  ...
                  <div className="col-lg-6">
                    <div className="step-header">
                      <h5 data-aos="fade-left" data-aos-duration="800">
                        <img
                          src="/assets/img/icons/logo-icons2.svg"
                          alt=""
                        />{" "}
                        {item.step}
                      </h5>
