...
const worksData = [
  {
    ...
    img1Src: "/assets/img/all-images/works-img3.png",
    img2Src: "/assets/img/bg/work-bg3.png",
    duration: 800,
  },
  {
    ...
    img1Src: "/assets/img/all-images/works-img4.png",
    img2Src: "/assets/img/bg/work-bg4.png",
    duration: 1000,
  },
  {
    ...
    description:
      "You might not think much about your email, they could actually determine how many people see your emails.",
    img1Src: "/assets/img/all-images/works-img5.png",
    img2Src: "/assets/img/bg/work-bg5.png",
    duration: 1200,
  },
];
