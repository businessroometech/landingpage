...
const blogPosts = [
  {
    ...
    imgSrc: "/assets/img/all-images/blog-img4.png",
    link: "/blog-single",
  },
  {
    date: "15 Feb 2024",
    ...
    imgSrc: "/assets/img/all-images/blog-img5.png",
    link: "/blog-single",
  },
];
...
const Blog3Section: React.FC = () => {
  return (
    <div className="blog3-section-area sp2">
      <img src="/assets/img/bg/about-bg1.png" alt="" className="about-bg1" />
      <img src="/assets/img/bg/about-bg2.png" alt="" className="about-bg2" />
      <Container>
        <Row>
