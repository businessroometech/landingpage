...
const HeroSection: React.FC = () => {
  return (
    <div className="hero3-section-area">
      ...
      <img src="/assets/img/elements/star2.png" alt="" className="star4 keyframe5" />
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-5">
            <div className="header-images-area" data-aos="zoom-in" data-aos-duration="1000">
              <img src="/assets/img/elements/elements8.png" alt="" className="elements6 animation-key-1" />
              <img src="/assets/img/elements/star5.png" alt="" className="star5 keyframe5" />
              <div className="img1">
                <img src="/assets/img/bg/header-imgbg3.png" alt="" className="header-imgbg2" />
