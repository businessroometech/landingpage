...
const AboutSection: React.FC = () => {
  return (
    <div className="about3-section-area" id="about">
      <img src="/assets/img/bg/about-bg1.png" alt="Background 1" className="about-bg1" />
      <img src="/assets/img/bg/about-bg2.png" alt="Background 2" className="about-bg2" />
      <div className="container">
        <div className="row align-items-center">
          <div className="col-lg-6">
            <div className="about-images-area">
              <img src="/assets/img/all-images/about-img3.png" alt="About Us" />
            </div>
          </div>
          <div className="col-lg-6">
            <div className="about-header-area heading6">
              ...
              <div className="list-area" data-aos="fade-left" data-aos-duration="1100">
                <ul>
                  <li><img src="/assets/img/icons/check1.svg" alt="Check Icon" />Digital Marketing</li>
                  <li><img src="/assets/img/icons/check1.svg" alt="Check Icon" />Marketing Agency</li>
                </ul>
                <ul>
                  <li><img src="/assets/img/icons/check1.svg" alt="Check Icon" />SEO Optimization</li>
                  <li><img src="/assets/img/icons/check1.svg" alt="Check Icon" />First Working Process</li>
                </ul>
              </div>
              <div className="images-area" data-aos="fade-left" data-aos-duration="1200">
                <div className="img">
                  <img src="/assets/img/all-images/about-img4.png" alt="John Doe" />
                </div>
