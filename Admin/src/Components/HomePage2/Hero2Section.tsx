...
const Hero2Section: React.FC = () => {
    return (
        <div className="hero2-section-area">
            <img src="/assets/img/elements/star3.png" alt="" className="star3 keyframe5" />
            <img src="/assets/img/elements/star3.png" alt="" className="star4 keyframe5" />
            <Container>
                <Row className="align-items-center">
                    ...
                    <Col lg={5}>
                        <div className="header-images-area" data-aos="zoom-in" data-aos-duration="1000">
                            <img src="/assets/img/elements/elements6.png" alt="" className="elements6 aniamtion-key-1" />
                            <img src="/assets/img/elements/star4.png" alt="" className="star5 keyframe5" />
                            <div className="img1">
                                <img src="/assets/img/bg/header-imgbg2.png" alt="" className="header-imgbg2" />
