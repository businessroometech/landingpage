        ...
        <Row>
          <Col lg={12}>
            <div className="header-images-area">
              <div className="bg1">
                <img src="/assets/img/bg/header-bg4.png" alt="" />
              </div>
              <div className="img1" data-aos="zoom-in" data-aos-duration="1200">
                <img src="/assets/img/all-images/header-img7.png" alt="" className="header-img7" />
              </div>
              <div className="img2">
                <img src="/assets/img/all-images/header-img6.png" alt="" className="header-img6 animation-key-2" data-aos="fade-right" data-aos-duration="1000" />
                <img src="/assets/img/elements/elements10.png" alt="" className="elements10" />
              </div>
              <div className="img3">
                <img src="/assets/img/all-images/header-img4.png" alt="" className="header-img6 animation-key-1" data-aos="fade-right" data-aos-duration="1200" />
                <img src="/assets/img/elements/elements9.png" alt="" className="elements10" />
              </div>
              <div className="img4">
                <img src="/assets/img/all-images/header-img5.png" alt="" className="header-img6 animation-key-2" data-aos="fade-left" data-aos-duration="1000" />
                <img src="/assets/img/icons/sound-icons2.svg" alt="" className="elements10 animation-key-5" />
              </div>
              <div className="content" data-aos="fade-left" data-aos-duration="1200">
                ...
                <span><img src="/assets/img/icons/star1.svg" alt="" />CEO & Founder</span>
              </div>
            </div>
          </Col>
        </Row>
