...
const serviceImages = [
  "/assets/img/icons/service-icon5.svg",
  "/assets/img/icons/service-icon6.svg",
  "/assets/img/icons/service-icon7.svg",
  "/assets/img/icons/service-icon8.svg",
  "/assets/img/icons/service-icon9.svg",
  "/assets/img/icons/service-icon10.svg",
];
