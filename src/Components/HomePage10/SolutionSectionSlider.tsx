...
const solutionSlides = [
  {
    id: 1,
    imgSrc: "/assets/img/all-images/solution-img5.png",
  ...
  {
    id: 2,
    imgSrc: "/assets/img/all-images/solution-img6.png",
    title: "Email Verification",
    description:
      "You might not think much about your email, they could actually determine how many people see your emails",
    link: "/case-single",
  ...
  {
    id: 3,
    imgSrc: "/assets/img/all-images/solution-img7.png",
    title: "Email Verification",
    description:
      "You might not think much about your email, they could actually determine how many people see your emails",
    link: "/case-single",
          ...
          <Col lg={12}>
            <div className="solution-header heading15">
              ...
              <div className="auhtor-area">
                <div className="img1">
                  <img
                    src="/assets/img/all-images/author-img1.png"
                    alt="Author"
                  />
                </div>
