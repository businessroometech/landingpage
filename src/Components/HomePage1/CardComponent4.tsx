...
function ChatComponent() {
  ...
  return (
    <div style={{ width: '300px', borderRadius: '16px', backgroundColor: '#fff', boxShadow: '0 4px 12px rgba(0,0,0,0.1)', overflow: 'hidden', fontFamily: 'Roboto, sans-serif', borderTopLeftRadius: '0' }}>
      {/* Header Section */}
