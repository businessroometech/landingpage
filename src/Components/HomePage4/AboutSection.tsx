        ...
        <Row>
          <Col lg={7} className="m-auto">
            <div className="about5-header text-center heading10">
              <h5>
                <img src="/assets/img/icons/logo-icons6.svg" alt="Logo Icon" />
        ...
        <Row className="align-items-center">
          <Col lg={6}>
            <div className="about-all-images-area">
              <img src="/assets/img/elements/elements12.png" alt="Element 12" className="elements12 keyframe5" />
              <img src="/assets/img/elements/elements13.png" alt="Element 13" className="elements13 keyframe5" />
              <Row>
                <Col lg={6} md={6}>
                  <div className="img1 image-anime">
                    <img src="/assets/img/all-images/about-img5.png" alt="About Image 5" />
                  </div>
                </Col>
                <Col lg={6} md={6}>
                  <div className="img2 image-anime">
                    <div className="space100"></div>
                    <img src="/assets/img/all-images/about-img6.png" alt="About Image 6" />
                  </div>
                </Col>
              </Row>
            </div>
