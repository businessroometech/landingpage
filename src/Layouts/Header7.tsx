...
const Header7: React.FC = () => {
  ...
  return (
    <header
      className={`header-area homepage7 header header-sticky d-none d-lg-block ${
        isSticky ? "sticky" : ""
      }`}
    >
      <div className="container">
        <div className="row">
          <div className="col-lg-12">
            ...
            <Link to="/contact" className="header-btn13">
