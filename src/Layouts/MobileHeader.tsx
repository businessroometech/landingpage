    ...
    subMenu: [
      {
        ...
        subMenu: [
          { title: "Home One", link: "/" },
          { title: "Home Two", link: "/index2" },
          { title: "Home Three", link: "/index3" },
          { title: "Home Four", link: "/index4" },
          { title: "Home Five", link: "/index5" },
          { title: "Home Six", link: "/index6" },
          { title: "Home Seven", link: "/index7" },
          { title: "Home Eight", link: "/index8" },
          { title: "Home Nine", link: "/index9" },
          { title: "Home Ten", link: "/index10" },
        ],
      },
      {
        title: "Landing Page",
        subMenu: [
          { title: "Home One", link: "/single-index1" },
          { title: "Home Two", link: "/single-index2" },
          {
            title: "Home Three",
            link: "/single-index3",
          },
          { title: "Home Four", link: "/single-index4" },
          { title: "Home Five", link: "/single-index5" },
          { title: "Home Six", link: "/single-index6" },
          {
            title: "Home Seven",
            link: "/single-index7",
          },
          ...
          { title: "Home Nine", link: "/single-index9" },
          { title: "Home Ten", link: "/single-index10" },
        ],
      },
    ],
  },
...
const navItems = [
  { title: "About", link: "/about" },
  {
    ...
    link: "/features",
    subMenu: [
      { title: "Service One", link: "/service1" },
      { title: "Service Two", link: "/service2" },
      { title: "Service Three", link: "/service3" },
      { title: "Service Four", link: "/service4" },
      { title: "Service Five", link: "/service5" },
    ],
  },
  {
    title: "Blogs",
    subMenu: [
      { title: "Blog One", link: "/blog" },
  ...
  },
  {
    title: "Pages",
    subMenu: [
      { title: "Case Study One", link: "/case" },
...
const MobileHeaderSidebar: React.FC = () => {
  ...
  console.log(document.body.classList[0], logoUrl, headerClass);
