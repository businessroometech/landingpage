...
const Footer7: React.FC = () => {
  const socialLinks = [
    { href: "#", src: "/assets/img/icons/facebook6.svg", alt: "Facebook" },
    { href: "#", src: "/assets/img/icons/instagram6.svg", alt: "Instagram" },
    { href: "#", src: "/assets/img/icons/linkedin6.svg", alt: "LinkedIn" },
    { href: "#", src: "/assets/img/icons/twitter6.svg", alt: "Twitter" },
  ];
  ...
  return (
    <footer className="footer7-section-area">
      <Container>
        <Row>
          <Col lg={3} md={6}>
            <div className="footer-logo-area">
              <img src="/assets/img/logo/logo8.png" alt="Logo" />
              <p>
          ...
          <Col lg={4} md={6}>
            <div className="footer-logo-area3">
              ...
              <form action="#">
                ...
                <button className="header-btn13">Subscribe</button>
              </form>
            </div>
          </Col>
        </Row>
